...
class TestLLMFactory:
    ...
    def test_create_anthropic_provider(self, mock_anthropic_class, mock_config):
        ...
        mock_anthropic_class.assert_called_once_with(
            api_key=mock_config.ANTHROPIC_API_KEY, model=mock_config.ANTHROPIC_MODEL
        )
        assert result == mock_provider
    ...
    def test_create_openai_provider(self, mock_openai_class, mock_config):
        ...
        mock_openai_class.assert_called_once_with(
            api_key=mock_config.OPENAI_API_KEY, model=mock_config.OPENAI_MODEL
        )
        assert result == mock_provider
    ...
    def test_create_ollama_provider(self, mock_ollama_class, mock_config):
        ...
        mock_ollama_class.assert_called_once_with(
            model=mock_config.OLLAMA_MODEL, base_url=mock_config.OLLAMA_BASE_URL
        )
        assert result == mock_provider
    ...
    @patch("llm_factory.BedrockProvider")
    def test_bedrock_without_explicit_credentials(
    ...
    @patch("llm_factory.BedrockProvider")
    def test_factory_logs_provider_creation(
        self, mock_bedrock_class, mock_logger, mock_config
    ):
